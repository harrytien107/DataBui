...
CREATE TABLE TT ( 
	...
	DT float, 
	MAMN char(3),
    foreign key (MAMN) references MIEN(MAMN)
);
...
CREATE TABLE BG ( 
    ...
    foreign key (MATT) references TT(MATT)
);
...
CREATE TABLE LG (
    ...
    foreign key (MATT) references TT(MATT),
    foreign key (MALG) references TT(MATT)
);
...
('P01','HÀ GIANG',854679,7929.5,'C01'),
...
('P26','THANH HÓA',3640128,11114.7,'C02'),
('P27','NGHỆ AN',3327791,16493.7,'C02'),
('P28','HÀ TĨNH',1288866,5990.7,'C02'),
('P29','QUẢNG BÌNH',895430,8065.3,'C02'),
('P30','QUẢNG TRỊ',632375,4739.8,'C02'),
('P31','THỪA THIÊN HUẾ',1128620,5048.2,'C02'),
('P32','ĐÀ NẴNG',1134310,1284.9,'C02'),
('P33','QUẢNG NAM',1495812,10574.7,'C02'),
('P34','QUẢNG NGÃI',1231697,5135.2,'C02'),
('P35','KON TUM',540438,9674.2,'C02'),
('P36','GIA LAI',1513847,15510.8,'C02'),
('P37','BÌNH ĐỊNH',1486918,6066.2,'C02'),
('P38','PHÚ YÊN',961152,5023.4,'C02'),
('P39','ĐẮK LẮK',1869322,13030.5,'C02'),
('P40','KHÁNH HÒA',1231107,5137.8,'C02'),
('P41','ĐẮK NÔNG',622168,6509.3,'C02'),
('P42','LÂM ĐỒNG',1296606,9783.2,'C02'),
('P43','NINH THUẬN',590467,3355.3,'C02'),
('P44','BÌNH THUẬN',1230808,7812.8,'C02'),
('P45','BÌNH PHƯỚC',994679,6877,'C03'),
